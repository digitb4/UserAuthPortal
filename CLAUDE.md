...
```bash
sonar analyze agentic --project digitb4_UserAuthPortal --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project digitb4_UserAuthPortal --depth DEEP
```
